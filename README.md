...
export const NAV_LINKS = [
  ...
  { href: "/", key: "how_TravelLink_work", label: "How TravelLink Work?" },
...
export const FEATURES = [
  ...
  },
  {
    ...
    variant: "green",
    description:
      "Schedule an adventure with friends. On holidays, there are many interesting offers from TravelLink. That way, there's no more discussion",
  },
  {
...
export const FOOTER_LINKS = [
  ...
  {
    title: "Our Community",
    links: ["Climbing xixixi", "Hiking TravelLink", "TravelLink kinthill"],
  },
];
...
export const FOOTER_CONTACT_INFO = {
  ...
  links: [
    ...
    { label: "Email Officer", value: "TravelLink@akinthil.com" },
  ],
};
